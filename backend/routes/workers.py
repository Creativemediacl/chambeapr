...
CATEGORIAS = ["Electricista","Plomero","Aire Acondicionado","Carpintero","Pintor","Techado","Construccion","Jardineria","Limpieza","Mudanzas","Cocinero a Domicilio","Catering","Reposteria","Chef Privado","Meal Prep","Barbero a Domicilio","Maquillista","Masajista","Fotografia","Clases Particulares","Servicios Digitales","Diseno Web","Redes Sociales","Fotografia y Video","IT y Computadoras","Marketing Digital","Consultoria de Negocios","Reparacion de Computadoras","Aplicaciones Moviles"]
